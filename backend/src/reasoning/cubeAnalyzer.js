...
const OLL_CASES = [
  {
    id: 1,
    name: "Dot (all flipped)",
    pattern: "00000000",
    algorithm: "R U2 R2 F R F' U2 R' F R F'",
    difficulty: 3,
    category: "dot",
    recognition: "No yellow pieces oriented on top"
  },
  {
    id: 2,
    name: "Dot + corner",
    ...
    difficulty: 3,
    category: "dot",
    recognition: "One corner oriented, rest unoriented"
  },
  {
    id: 3,
    name: "P-shape",
    ...
    difficulty: 1,
    category: "line",
    recognition: "Edge at front-right oriented"
  },
  {
    id: 4,
    name: "P-shape mirror",
    ...
    difficulty: 1,
    category: "line",
    recognition: "Edge at front-left oriented"
  },
  {
    id: 5,
    name: "Small L",
    ...
    difficulty: 2,
    category: "L-shape",
    recognition: "Two adjacent edges oriented"
  },
  {
    id: 6,
    name: "Small L mirror",
    ...
    difficulty: 2,
    category: "L-shape",
    recognition: "Two adjacent edges oriented (mirror)"
  },
  {
    id: 7,
    name: "T-shape",
  ...
  },
  {
    ...
    difficulty: 1,
    category: "fish",
    recognition: "Fish pattern with head at front-right"
  },
  {
    id: 10,
    name: "Sune",
    ...
    difficulty: 1,
    category: "sune",
    recognition: "One corner unoriented"
  },
  {
    id: 11,
    name: "Anti-Sune",
  ...
  },
  {
    ...
    difficulty: 2,
    category: "H-shape",
    recognition: "Line of four oriented pieces"
  },
  {
    id: 13,
    name: "Pi",
    ...
    difficulty: 2,
    category: "pi",
    recognition: "Pi shape — bar at back"
  },
  {
    id: 14,
    name: "U-OLL",
  ...
  },
  {
    ...
    difficulty: 3,
    category: "T-shape",
    recognition: "T shape on top"
  },
  {
    id: 17,
    name: "Full oriented (skip)",
    pattern: "11111111",
    algorithm: "(none — OLL skip!)",
    difficulty: 0,
    category: "skip",
    recognition: "All yellow on top — OLL skip!"
  },
  {
    id: 20,
    name: "Cross complete",
    ...
    difficulty: 1,
    category: "cross",
    recognition: "Yellow cross complete, corners need orienting"
  },
  {
    id: 21,
    name: "Double Sune",
    ...
    difficulty: 2,
    category: "sune",
    recognition: "Two sune patterns combined"
  },
  {
    id: 22,
    name: "Bruno",
    pattern: "11110101",
    algorithm: "R U2 R2 U' R2 U' R' U R' U' R U2 R'",
    difficulty: 3,
    category: "bruno",
    recognition: "Complex corner orientation"
  },
  {
    id: 23,
    name: "Lights",
    ...
    difficulty: 3,
    category: "lights",
    recognition: "Light patterns on sides"
  },
  {
    id: 24,
    name: "Zombie",
  ...
  },
  {
    ...
    difficulty: 2,
    category: "wario",
    recognition: "Opposite of Wario"
  },
  {
    id: 26,
    name: "Wario",
    pattern: "11110100",
    algorithm: "R' F R F' r U R' U' r'",
    difficulty: 2,
    category: "wario",
    recognition: "W-shape on top"
  },
  {
    id: 27,
    name: "Triple Sune",
    ...
    difficulty: 1,
    category: "sune",
    recognition: "Three sune orientations"
  },
  {
    id: 33,
    name: "Knight move",
    ...
    difficulty: 2,
    category: "knight",
    recognition: "Knight-move pattern"
  },
  {
    id: 37,
    name: "Awkward shape",
    ...
    difficulty: 3,
    category: "awkward",
    recognition: "Awkward orientation pattern"
  },
  {
    id: 45,
    name: "Line + dots",
...
const PLL_CASES = [
  {
    ...
    difficulty: 1,
    category: "diagonal",
    recognition: "Opposite edges swapped",
    moveCount: 7
  },
  {
    id: "Z",
    ...
    difficulty: 2,
    category: "adjacent",
    recognition: "Adjacent edges swapped",
    moveCount: 9
  },
  {
    id: "Ua",
    ...
    difficulty: 1,
    category: "corner-cycle",
    recognition: "Three edges cycled clockwise",
    moveCount: 11
  },
  {
    id: "Ub",
    ...
    difficulty: 1,
    category: "corner-cycle",
    recognition: "Three edges cycled counter-clockwise",
    moveCount: 11
  },
  {
    id: "T",
    ...
    difficulty: 2,
    category: "swap",
    recognition: "Adjacent corner-edge swap",
    moveCount: 14
  },
  {
    id: "Jb",
    ...
    difficulty: 2,
    category: "swap",
    recognition: "Adjacent corners + edge swap",
    moveCount: 10
  },
  {
    id: "Ja",
  ...
  },
  {
    ...
    difficulty: 3,
    category: "swap",
    recognition: "Edge-corner swap with block preserved",
    moveCount: 14
  },
  {
    id: "Ra",
  ...
  },
  {
    ...
    difficulty: 4,
    category: "swap",
    recognition: "Corner swap with edge preservation",
    moveCount: 18
  },
  {
    id: "V",
  ...
  },
  {
    ...
    difficulty: 3,
    category: "diagonal",
    recognition: "Diagonal corner swap (Y pattern)",
    moveCount: 16
  },
  {
    id: "E",
    ...
    difficulty: 4,
    category: "diagonal",
    recognition: "All four corners swap",
    moveCount: 16
  },
  {
    id: "Na",
    ...
    difficulty: 5,
    category: "swap",
    recognition: "Two adjacent corner swaps",
    moveCount: 22
  },
  {
    id: "Nb",
  ...
  },
  {
    ...
    difficulty: 4,
    category: "G-perm",
    recognition: "G-pattern (c variant)",
    moveCount: 15
  },
  {
    id: "Gd",
    ...
    difficulty: 4,
    category: "G-perm",
    recognition: "G-pattern (d variant)",
    moveCount: 15
  },
  {
    id: "Ga",
    ...
    difficulty: 4,
    category: "G-perm",
    recognition: "G-pattern (a variant)",
    moveCount: 15
  },
  {
    id: "Gb",
    ...
    difficulty: 4,
    category: "G-perm",
    recognition: "G-pattern (b variant)",
    moveCount: 15
  },
  {
    id: "Aa",
    ...
    difficulty: 2,
    category: "corner-cycle",
    recognition: "Three corners cycled clockwise",
    moveCount: 9
  },
  {
    id: "Ab",
    ...
    difficulty: 2,
    category: "corner-cycle",
    recognition: "Three corners cycled counter-clockwise",
    moveCount: 9
  }
];
...
export class CubeAnalyzer {
  ...
  rateDifficulty(moves) {
    ...
    if (moveCount <= 10) {
      score += 1;
      factors.push("Short solution (≤10 moves)");
    } else if (moveCount <= 20) {
      score += 2;
      factors.push("Medium solution (11-20 moves)");
    } else {
      score += 3;
      factors.push("Long solution (>20 moves)");
    }
    ...
    if (hasPrimeMoves) {
      score += 1;
      factors.push("Contains prime (') moves");
    }
    if (hasDoubleMoves) {
      score += 1;
      factors.push("Contains double (2) moves");
    }
    ...
    if (hasComplex) {
      score += 2;
      factors.push("Contains slice/wide moves");
    }

    const label =
      score <= 2 ? "Beginner" : score <= 4 ? "Intermediate" : score <= 6 ? "Advanced" : "Expert";
  ...
  #updateStats(entry) {
    ...
    if (entry.method) {
      this.stats.methodBreakdown[entry.method] =
        (this.stats.methodBreakdown[entry.method] || 0) + 1;
    }
  }
}
