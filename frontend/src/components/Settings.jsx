    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-slate-800 dark:text-white"
        >
          {/* Header */}
              ...
              <div className="space-y-2">
                ...
                >
                  <Toggle
                    ...
                    label={settings.voiceEnabled ? "Voice commands on" : "Voice commands off"}
                  />
                </SettingItem>
                ...
                <div className="rounded-lg bg-gray-50 p-4 dark:bg-slate-700">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-blue-600 dark:text-blue-400">Shift + M</span>
                    </div>
                    <div className="flex justify-between">
